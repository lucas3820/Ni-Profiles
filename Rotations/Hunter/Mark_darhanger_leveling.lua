...
-----------------------------------
	["Window"] = function()
		if not popup_shown then
		 ni.debug.popup("Marksmanship Hunter by darhanger for 3.3.5a -- Modified by Xcesius for leveling", 
...
ni.bootstrap.rotation("Mark_darhanger_leveling", queue, abilities, data)