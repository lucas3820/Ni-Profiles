...
-----------------------------------
	["Window"] = function()
		if not popup_shown then
		 ni.debug.popup("Restoration Shaman by darhanger -- Modified by Xcesius for leveling",  
...
ni.bootstrap.rotation("Restoration_darhanger_leveling", queue, abilities, data)